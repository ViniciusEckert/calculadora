...
# buttons
b_tan = Button(frame_cientifica, text="tan", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('tan'))
b_tan.place(x=0, y=1)

b_sin = Button(frame_cientifica, text="sin", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('sin'))
b_sin.place(x=59, y=1)

b_cos = Button(frame_cientifica, text="cos", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('cos'))
b_cos.place(x=118, y=1)

b_sqrt = Button(frame_cientifica, text="sqrt", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('sqrt'))
b_sqrt.place(x=177, y=1)

b_log = Button(frame_cientifica, text="log", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('log'))
b_log.place(x=0, y=30)

b_log10 = Button(frame_cientifica, text="log10", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('log10'))
b_log10.place(x=59, y=30)

b_euler = Button(frame_cientifica, text="e", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('e'))
b_euler.place(x=118, y=30)

b_pow = Button(frame_cientifica, text="pow", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('pow'))
b_pow.place(x=177, y=30)

b_12 = Button(frame_cientifica, text="pi", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('pi'))
b_12.place(x=0, y=58)

b_13 = Button(frame_cientifica, text=",", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values(','))
b_13.place(x=59, y=58)

b_14 = Button(frame_cientifica, text="(", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('('))
b_14.place(x=118, y=58)

b_15 = Button(frame_cientifica, text=")", width=6, height=1, bg=cor11, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values(')'))
...
b_18 = Button(frame_quadros, text="=", width=6, height=1, bg=co12, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:calculate())
